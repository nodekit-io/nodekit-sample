...
// THIS FILE IS ONLY USED IF main app://app.nkar/index.html is not set in package.json

const nodekit = require('electro').app,
      BrowserWindow = require('electro').BrowserWindow,
      protocol = require('electro').protocol;

console.log("STARTING NODEKIT ELECTRO APPLICATION");

protocol.interceptInternalProtocol("app");

nodekit.on("ready", function() {

           var p = new BrowserWindow({ 'preloadURL': 'app://app.nkar/index.html',
